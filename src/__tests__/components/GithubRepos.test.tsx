...
jest.mock('lucide-react', () => ({
  Star: function MockStar() {
    return <svg data-testid="icon-star" />;
  },
  GitFork: function MockGitFork() {
    return <svg data-testid="icon-git-fork" />;
  },
  ExternalLink: function MockExternalLink() {
    return <svg data-testid="icon-external-link" />;
  },
}));
