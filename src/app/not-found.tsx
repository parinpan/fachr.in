...
export default function NotFound() {
    ...
    return (
        <div className="relative min-h-screen w-full flex flex-col items-center justify-center bg-black text-neutral-100 px-4 overflow-hidden">
            {/* Radial Gradient */}
            ...
            <div className="relative z-10 w-full max-w-2xl text-center space-y-8">
                ...
                <div className="flex justify-center">
                    <div className="p-4 bg-violet-950/50 backdrop-blur-sm rounded-2xl border border-violet-500/30">
                ...
                <div className="space-y-2">
                    <h1 className="text-9xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white via-violet-200 to-violet-500">
                        404
                    </h1>
                ...
                {/* Error Message */}
                <div className="bg-violet-950/30 backdrop-blur-md rounded-lg border border-violet-500/30 p-6">
                    <p className="text-lg text-violet-100 font-mono">
