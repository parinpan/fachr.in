...
export default function About() {
    return (
        <section className="mb-12" aria-labelledby="about-heading">
            ...
            <p className="text-lg text-gray-700 dark:text-neutral-300 leading-relaxed text-justify">
                {siteConfig.about.greeting}
                <Hand className="inline-block w-5 h-5 ml-2 text-black-500 dark:text-neutral-400" />. {siteConfig.about.description}{' '}
                <a
