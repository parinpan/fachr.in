...
export default function Contact() {
  ...
  return (
    <section className="mb-12" aria-labelledby="contact-heading">
      <h3
        id="contact-heading"
        className="text-2xl font-bold mb-6 text-gray-900 dark:text-neutral-100"
      >
      ...
      <div className="bg-gray-50 dark:bg-neutral-800/50 rounded-2xl p-8 text-center border border-gray-100 dark:border-neutral-700">
        <h4 className="text-xl font-bold text-gray-900 dark:text-neutral-100 mb-2">
          {siteConfig.contact.collaboration.title}
        </h4>
        <p className="text-gray-800 dark:text-neutral-200 mb-6 max-w-lg mx-auto">
