                ...
                >
                  ...
                  <div className="p-6 pb-4 border-b border-[var(--color-border-light)]">
                    <div className="flex items-start justify-between gap-4 mb-3">
                      ...
                      <button
                        ...
                        aria-label={
                          expanded
                            ? siteConfig.ui.experience.collapse
                            : siteConfig.ui.experience.expand
                        }
                      >
                    ...
                    <div className="p-6 pt-5 animate-in fade-in slide-in-from-top-2 duration-300">
                      ...
                      <ul className="space-y-3.5 mb-6">
                        {exp.description.map((desc: string, i: number) => (
                          <li
                            key={i}
                            className="flex items-start gap-3 text-gray-800 dark:text-neutral-200 text-[15px] leading-relaxed"
                          >
                  ...
                  {!expanded && (
                    <div className="p-6 pt-5">
                      <p className="text-gray-800 dark:text-neutral-200 text-sm leading-relaxed line-clamp-2">
                        {exp.description[0]}
                      </p>
