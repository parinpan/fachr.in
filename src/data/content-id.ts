...
export const siteConfigId: SiteConfig = {
  ...
  hero: {
    ...
    image: '/images/fachrin-cartoon.png',
    badges: [
      {
  ...
  about: {
    ...
    description:
      'Saya seorang insinyur perangkat lunak yang tinggal di Berlin, Jerman. Kesehariannya berkutat dengan teknologi mutakhir dan membangun sistem perangkat lunak yang dapat berkembang pesat untuk perusahaan rintisan hingga korporasi besar. Jika ingin mengobrol atau bekerja sama,',
    cta: {
      text: 'mari terhubung',
  ...
  works: [
    ...
    },
    {
      ...
      description:
        'Mengembangkan Widget Tip versi baru yang merevolusi pengalaman pengguna dalam memberikan tip kepada pengemudi. Fitur ini meningkatkan jumlah rata-rata tip sebesar 100%, dan meningkatkan frekuensi pemberian tip sebesar 13%.',
    ...
    },
    {
      ...
      description:
        'Membangun sistem pengiriman konten dinamis untuk beranda aplikasi Gojek, memungkinkan pengacakan kartu yang dipersonalisasi berdasarkan perilaku dan preferensi pengguna.',
    ...
    },
    {
      ...
      description:
        'Mengimplementasikan pagar geografis dan pembatasan layanan berbasis area untuk memastikan kepatuhan terhadap peraturan lokal dan mengoptimalkan ketersediaan layanan di berbagai wilayah.',
  ...
  seo: {
    ...
    description:
      'Senior Product Engineer di Berlin. Spesialis distributed systems skala besar, Golang, dan cloud architecture. Pengalaman di Upvest, Choco, Delivery Hero, dan Gojek.',
    keywords: [
      'Software Engineer',
      'Product Engineer',
      'Distributed Systems',
  ...
  appearances: {
    ...
    description:
      'Kumpulan pembicaraan, wawancara, dan liputan tentang rekayasa perangkat lunak dan teknologi.',
    items: [
      {
        type: 'video' as const,
        ...
        description:
          'Tim Rekayasa Upvest berkumpul di Berlin untuk Hari Rekayasa 2025. Sehari penuh berkolaborasi, mempererat hubungan personal, dan menyelami kebutuhan klien lebih dalam.',
        date: 'November 2025',
        platform: 'YouTube',
        duration: '2:13',
        language: 'Inggris',
      },
      {
        ...
        description:
          'Menyampaikan lokakarya tentang Teorema CAP pada basis data terdistribusi untuk program Magister Sains Data dan Kecerdasan Buatan di Universitas Sumatera Utara.',
        date: 'Maret 2023',
        platform: 'YouTube',
        duration: '2:32:49',
        language: 'Indonesia',
      },
      {
        ...
        description:
          'Membahas jalur karier dan peran teknologi di industri perusahaan rintisan Indonesia yang berkembang pesat, sebagai bagian dari perayaan Dies Natalis kampus.',
        date: 'November 2020',
        platform: 'Webinar',
        language: 'Indonesia',
      },
      {
        ...
        description:
          'Menelusuri pergeseran paradigma dari Pemrograman Berorientasi Objek ke Pemrograman Fungsional. Pembahasan mendalam tentang berpikir secara fungsional untuk kualitas dan pemeliharaan kode yang lebih baik.',
        date: 'Juni 2020',
        platform: 'Webinar',
        language: 'Indonesia',
      },
  ...
  podcasts: [
    {
      ...
      episodeUrl:
        'https://open.spotify.com/embed/episode/42h5loszLcsDAZnNfY01ME?utm_source=generator',
      description:
        'Berbagi pengalaman dan wawasan bekerja sebagai Insinyur Produk di ekosistem perusahaan rintisan teknologi Indonesia.',
      date: 'Agustus 2021',
      language: 'Indonesia',
    },
  ],
  ...
  blog: {
    ...
    emptyState: {
      ...
      description:
        'Sedang menyusun beberapa tulisan tentang rekayasa, sistem, dan kehidupan. Silakan mampir lagi nanti!',
    },
  },
    ...
    sections: [
      {
        title: '📍 Lokasi',
        content:
          'Tinggal di <strong>Berlin, Jerman</strong> 🇩🇪. Jauh dari Indonesia, tapi Berlin malah terasa seperti rumah baru. Saya masih terus mengikuti perkembangan tanah air walaupun betah berada disini. Oh ya, saya juga sedang mengajukan <strong>izin tinggal permanen</strong>.',
      },
      {
        title: '💼 Pekerjaan',
        content:
          'Saya bekerja sebagai <strong>Senior Product Engineer</strong> di <strong>Upvest</strong>, membantu membuka akses investasi untuk semua orang. Kami membangun infrastruktur finansial untuk masa depan, menantang, berskala besar, dan sangat memuaskan.',
      },
      {
        title: '🌱 Perkembangan',
        content:
          'Keluar sejenak dari gelembung dunia teknologi. Saya lagi belajar soal <strong>keuangan pribadi dan investasi</strong>, sambil mengikuti rasa ingin tahu ke berbagai <strong>topik sains</strong> apapun yang menarik. Terlepas dari semuanya, saya sedang mempelajari hal yang paling menantang yaitu: <strong>menjadi seorang ayah</strong>.',
      },
      {
        title: '⚡️ Hobi',
        content:
          'Bahasa cinta saya adalah makanan dan jalan-jalan. Saya dan istri biasanya selalu merencanakan liburan berdasarkan <strong>apa yang ingin kami makan</strong>. Di luar itu, biasanya saya binge-watch film-film di Netflix atau membaca artikel random di internet yang membuat saya <strong>tidur hingga larut malam</strong>.',
      },
    ],
  },
