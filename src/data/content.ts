...
export const siteConfig: SiteConfig = {
  ...
  about: {
    ...
    description:
      "A software engineer based in Berlin, Germany. I've been working closely with the cutting-edge technology as well as in the making of scalable and high-performing software for startups and enterprises. If you'd like to converse, discuss, or create something amazing together,",
    cta: {
  ...
  seo: {
    ...
    description:
      'A Senior Product Engineer based in Berlin, specializing in high-scale distributed systems, Golang, and cloud architecture. Experienced at Upvest, Choco, Delivery Hero, and Gojek. Building the financial infrastructure of tomorrow.',
    keywords: [
      'Software Engineer',
      'Product Engineer',
      'Distributed Systems',
    ...
    items: [
      {
        ...
        description:
          "Upvest's Engineering team gathered in Berlin for Engineering Day 2025, a day to collaborate, strengthen personal connections, and dive deep into client needs.",
        date: 'November 2025',
        platform: 'YouTube',
        duration: '2:13',
        language: 'English',
      },
      {
        ...
        description:
          "I delivered a workshop on the CAP Theorem in distributed databases for the Data Science and Artificial Intelligence master's program at Universitas Sumaterta Utara.",
        date: 'March 2023',
        platform: 'YouTube',
        duration: '2:32:49',
        language: 'Indonesian',
      },
      {
        ...
        description:
          "Discussing career paths and tech roles in Indonesia's rapidly growing start-up industry, as part of the university's Dies Natalis celebration.",
        date: 'November 2020',
        platform: 'Webinar',
        language: 'Indonesian',
      },
      {
        ...
        description:
          'Exploring the paradigm shift from Object-Oriented to Functional Programming. A deep dive into thinking functionally for better code quality and maintainability.',
        date: 'June 2020',
        platform: 'Webinar',
        language: 'Indonesian',
      },
  ...
  podcasts: [
    {
      ...
      episodeUrl:
        'https://open.spotify.com/embed/episode/42h5loszLcsDAZnNfY01ME?utm_source=generator',
      description:
        "Sharing experiences and insights from working as a Product Engineer in Indonesia's tech startup ecosystem.",
      date: 'August 2021',
      language: 'Indonesian',
    },
  ],
  ...
  blog: {
    ...
    emptyState: {
      ...
      description:
        "I'm currently crafting some thoughts on engineering, systems, and life. Check back soon!",
    },
  },
  ...
  now: {
    ...
    sections: [
      ...
      },
      {
        title: '💼 Work',
        content:
          "I'm a Senior Product Engineer at <strong>Upvest</strong>, helping democratize investment. We're building the financial infrastructure of tomorrow. It's challenging, high-scale, and incredibly rewarding.",
      },
      {
        title: '🌱 Growth',
        content:
          "Stepping outside the tech bubble. I'm educating myself on <strong>personal finance</strong> and <strong>investing</strong>, and following my curiosity into random <strong>scientific</strong> rabbit holes. Above all, I'm learning the most challenging framework of all: <strong>fatherhood</strong>.",
      },
      {
        title: '⚡️ Hobbies',
        content:
          "My love language is <strong>food</strong> and <strong>travel</strong>. My wife and I basically plan our trips around what we want to eat. When I'm not doing that, I'm probably deep into a Netflix binge or reading some random corner-of-the-internet article that keeps me up way too late.",
      },
    ],
  },
