...
export const cardStyles = {
  ...
  elevated:
    'bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-2xl shadow-md',
  interactive:
    'bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl shadow-sm hover:shadow-md hover:border-gray-300 dark:hover:border-neutral-600 transition-all cursor-pointer',
} as const;
...
export const buttonStyles = {
  primary:
    'inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-gray-900 dark:bg-neutral-100 dark:text-neutral-900 rounded-lg hover:bg-gray-800 dark:hover:bg-neutral-200 transition-colors',
  secondary:
    'p-2 text-[var(--color-text-tertiary)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-interactive-bg)] rounded-full transition-colors',
...
export const textStyles = {
  ...
  body: 'text-lg text-gray-800 dark:text-neutral-200 leading-relaxed',
...
export const badgeStyles = {
  ...
  default:
    'bg-neutral-100 dark:bg-black/90 text-neutral-600 dark:text-neutral-200 border border-neutral-200 dark:border-neutral-800',
...
export const modalStyles = {
  ...
  content:
    'relative w-full max-w-2xl bg-white dark:bg-neutral-800 rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200',
  closeButton:
    'absolute top-4 right-4 p-2 bg-black/20 hover:bg-black/40 text-white rounded-full backdrop-blur-md transition-colors',
} as const;
...
export const inputStyles = {
  ...
  search:
    'w-full h-14 outline-none focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 border-none ring-0 text-lg text-gray-900 dark:text-neutral-100 placeholder:text-gray-400 dark:placeholder:text-neutral-500 bg-transparent shadow-none appearance-none',
} as const;
...
export const patterns = {
  contactCard:
    'flex items-center gap-4 p-4 bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl hover:border-gray-300 dark:hover:border-neutral-600 hover:shadow-sm transition-all group',
  experienceCard:
    'relative bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl transition-all duration-300',
  metadataBadge:
    'flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--color-interactive-bg)] text-[var(--color-text-secondary)]',
} as const;
